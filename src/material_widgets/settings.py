u"""Customize the sources of the Material CSS and JS files by adding the
...
MATERIAL_CSS = getattr(settings, u'MATERIAL_CSS',
                       (u"https://unpkg.com/material-components-web@latest"
                        + u"/dist/material-components-web.min.css")
                      )

MATERIAL_JS = getattr(settings, u'MATERIAL_JS',
                      (u"https://unpkg.com/material-components-web@latest"
                       + u"/dist/material-components-web.min.js")
                     )
