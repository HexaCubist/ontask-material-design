u"""Customized form field widgets with templates styled with Material Components
for the Web.
...
__all__ = (
    u'MaterialCheckboxInput',
    u'MaterialCheckboxSelectMultiple',
    u'MaterialClearableFileInput',
    u'MaterialDateInput',
    u'MaterialDateTimeInput',
    u'MaterialEmailInput',
    u'MaterialFileInput',
    u'MaterialHiddenInput',
    u'MaterialMultipleHiddenInput',
    u'MaterialNullBooleanSelect',
    u'MaterialNumberInput',
    u'MaterialPasswordInput',
    u'MaterialRadioSelect',
    u'MaterialSelect',
    u'MaterialSelectDateWidget',
    u'MaterialSelectMultiple',
    u'MaterialSliderInput',
    u'MaterialSplitDateTimeWidget',
    u'MaterialSplitHiddenDateTimeWidget',
    u'MaterialSwitchInput',
    u'MaterialTextarea',
    u'MaterialTextInput',
    u'MaterialTimeInput',
    u'MaterialURLInput',
...
class MaterialComponent(widgets.Widget):
    u"""Superclass of Material widgets which adds attributes used by Material
    Components.
    ...
    **kwargs
    ...
    def get_context(self, name, value, attrs):
        context = super(MaterialComponent, self).get_context(name, value, attrs)
        context[u'widget'].update({
            u'label': self.label,
            u'help_text': self.help_text,
            })
        return context
    ...
    def media(self):  # pylint: disable=missing-docstring
        return widgets.Media(
            css={u'all': (
                MATERIAL_CSS,
                u'material_widgets/css/material_error.css',
                )},
            js=(MATERIAL_JS,),
            )
...
class MaterialMultiWidget(widgets.MultiWidget):
    u"""Superclass of Material split widgets which adds attributes used by
    ...
    **kwargs
    ...
    """
    template_name = u"material_widgets/widgets/material_multiwidget.html"

    def __init__(self, multiwidgets, attrs=None, label=None, *args, **kwargs):
        super(MaterialMultiWidget, self).__init__(multiwidgets, attrs, *args, **kwargs)
        self.label = label

    def get_context(self, name, value, attrs):
        context = super(MaterialMultiWidget, self).get_context(name, value, attrs)
        context[u'widget'].update({
            u'label': self.label,
            })
        return context
    ...
    def media(self):  # pylint: disable=missing-docstring
        return widgets.Media(
            css={u'all': (
                MATERIAL_CSS,
                u'material_widgets/css/material_error.css',
                u'material_widgets/css/material_multiwidget.css',
                )},
            js=(MATERIAL_JS,),
            )

    def decompress(self, value):
        u"""Return a list of decompressed values for the given compressed value.
...
class MaterialCheckbox(MaterialComponent):
    u"""Superclass of Material widgets that make use of Material Checkbox
    Components.
    ...
    class Media(object):  # pylint: disable=missing-docstring
        js = (u'material_widgets/js/material_checkbox.js',)


class MaterialFileButton(MaterialComponent):
    u"""Superclass of Material widgets that make use of Material File Button
    Components.
    ...
    **kwargs
    ...
    def __init__(self, button=None, icon=None, *args, **kwargs):
        super(MaterialFileButton, self).__init__(*args, **kwargs)
        self.button = button
        self.icon = icon

    def get_context(self, name, value, attrs):
        context = super(MaterialFileButton, self).get_context(name, value, attrs)
        context[u'widget'].update({
            u'button': self.button,
            u'icon': self.icon,
            })
        return context
    ...
    class Media(object):  # pylint: disable=missing-docstring
        css = {
            u'all': (
                u'material_widgets/css/material_button.css',
                u'material_widgets/css/material_file_input.css',
                )
            }
        js = (
            u'material_widgets/js/material_button.js',
            u'material_widgets/js/material_file_input.js',
            )


class MaterialSelectMenu(MaterialComponent):
    u"""Superclass of Material widgets that make use of Material Select Menu
    Components.
    ...
    class Media(object):  # pylint: disable=missing-docstring
        css = {
            u'all': (
                u'material_widgets/css/material_select.css',
                )
            }
        js = (u'material_widgets/js/material_select.js',)


class MaterialTextField(MaterialComponent):
    u"""Superclass of Material widgets that make use of Material TextField
    Components.
    ...
    **kwargs
    ...
    def __init__(self, persistent_help_text=False, *args, **kwargs):
        super(MaterialTextField, self).__init__(*args, **kwargs)
        self.persistent_help_text = persistent_help_text

    def get_context(self, name, value, attrs):
        context = super(MaterialTextField, self).get_context(name, value, attrs)
        context[u'widget'].update({
            u'persistent_help_text': self.persistent_help_text,
            })
        return context
    ...
    class Media(object):  # pylint: disable=missing-docstring
        css = {
            u'all': (
                u'material_widgets/css/material_text_field.css',
                )
            }
        js = (u'material_widgets/js/material_text_field.js',)


class MaterialCheckboxInput(MaterialCheckbox, widgets.CheckboxInput):
    u"""Material CheckboxInput
    ...
    """
    template_name = u'material_widgets/widgets/material_checkbox.html'


class MaterialCheckboxSelectMultiple(
        MaterialCheckbox,
        widgets.CheckboxSelectMultiple):
    u"""Material CheckboxSelectMultiple
    ...
    """
    template_name = u'material_widgets/widgets/material_checkbox_select.html'
    option_template_name = u'material_widgets/widgets/material_checkbox_option.html'

    def __init__(self, is_vertical=True, *args, **kwargs):
        super(MaterialCheckboxSelectMultiple, self).__init__(*args, **kwargs)
        self.is_vertical = is_vertical

    def get_context(self, name, value, attrs):
        context = super(MaterialCheckboxSelectMultiple, self).get_context(name, value, attrs)
        context[u'widget'].update({
            u'is_vertical': self.is_vertical,
            })
        return context
    ...
    def create_option(self,
        ...
        option = super(MaterialCheckboxSelectMultiple, self).create_option(
            name, value, label, selected, index, subindex, attrs
            )
        option[u'help_text'] = self.help_text[index]
        return option
...
class MaterialClearableFileInput(
    ...
    """
    template_name = u'material_widgets/widgets/material_clearable_file_input.html'
    ...
    class Media(object):  # pylint: disable=missing-docstring
        ...
        js = (
            u'material_widgets/js/material_button.js',
            u'material_widgets/js/material_checkbox.js',
            u'material_widgets/js/material_file_input.js',
            )


class MaterialDateInput(MaterialTextField, widgets.DateInput):
    u"""Material DateInput
    ...
    """
    template_name = u'material_widgets/widgets/material_date.html'


class MaterialDateTimeInput(MaterialTextField, widgets.DateTimeInput):
    u"""Material DateTimeInput
    ...
    """
    template_name = u'material_widgets/widgets/material_datetime.html'


class MaterialEmailInput(MaterialTextField, widgets.EmailInput):
    u"""Material EmailInput
    ...
    """
    template_name = u'material_widgets/widgets/material_email.html'


class MaterialFileInput(MaterialFileButton, widgets.FileInput):
    u"""Material FileInput
    ...
    """
    template_name = u'material_widgets/widgets/material_file.html'


class MaterialHiddenInput(MaterialComponent, widgets.HiddenInput):
    u"""Material HiddenInput
    ...
    """
    template_name = u'material_widgets/widgets/material_hidden.html'


class MaterialMultipleHiddenInput(
        MaterialComponent,
        widgets.MultipleHiddenInput):
    u"""Material MultipleHiddenInput
    ...
    """
    template_name = u'material_widgets/widgets/material_multiple_hidden.html'


class MaterialNullBooleanSelect(MaterialSelectMenu, widgets.NullBooleanSelect):
    u"""Material NullBooleanSelect
    ...
    """
    template_name = u'material_widgets/widgets/material_select.html'
    option_template_name = u'material_widgets/widgets/material_select_option.html'

    def get_context(self, name, value, attrs):
        context = super(MaterialNullBooleanSelect, self).get_context(name, value, attrs)
        attrs_class = (
            context[u'widget'][u'attrs'].get(u'class', u'')
            + u' mdc-select'
            ).strip()
        context[u'widget'][u'attrs'].update({
            u'class': attrs_class,
            })
        return context
...
class MaterialNumberInput(MaterialTextField, widgets.NumberInput):
    ...
    """
    template_name = u'material_widgets/widgets/material_number.html'


class MaterialPasswordInput(MaterialTextField, widgets.PasswordInput):
    u"""Material PasswordInput
    ...
    """
    template_name = u'material_widgets/widgets/material_password.html'


class MaterialRadioSelect(MaterialComponent, widgets.RadioSelect):
    u"""Material RadioSelect
    ...
    """
    template_name = u'material_widgets/widgets/material_radio.html'
    option_template_name = u'material_widgets/widgets/material_radio_option.html'

    def __init__(self, is_vertical=False, *args, **kwargs):
        super(MaterialRadioSelect, self).__init__(*args, **kwargs)
        self.is_vertical = is_vertical

    def get_context(self, name, value, attrs):
        context = super(MaterialRadioSelect, self).get_context(name, value, attrs)
        context[u'widget'].update({
            u'is_vertical': self.is_vertical,
            })
        return context
    ...
    def create_option(self,
                      name, value, label, selected, index,
                      subindex=None, attrs=None):
        option = super(MaterialRadioSelect, self).create_option(
            name, value, label, selected, index, subindex, attrs
            )
        option[u'help_text'] = self.help_text[index]
        return option
    ...
    class Media(object):
        u"""Material radio JS component."""
        js = (u'material_widgets/js/material_radio.js',)
...
class MaterialSelect(MaterialSelectMenu, widgets.Select):
    ...
    option_template_name = (
        u'material_widgets/widgets/'
        u'material_select_option.html'
        )

    def get_context(self, name, value, attrs):
        context = super(MaterialSelect, self).get_context(name, value, attrs)
        attrs_class = (
            context[u'widget'][u'attrs'].get(u'class', u'')
            + u' mdc-select__native-control'
            ).strip()
        context[u'widget'][u'attrs'].update({
            u'class': attrs_class,
            })
...
class MaterialSelectDateWidget(MaterialSelectMenu, widgets.SelectDateWidget):
    ...
    """
    template_name = u'material_widgets/widgets/material_select_date.html'
    select_widget = MaterialSelect

    class Media(object):
        u"""Material multiwidget CSS component."""
        css = {
            u'all': (
                u'material_widgets/css/material_multiwidget.css',
                )
...
class MaterialSelectMultiple(MaterialSelectMenu, widgets.SelectMultiple):
    ...
    """
    template_name = u'material_widgets/widgets/material_select_multiple.html'
    option_template_name = (
        u'material_widgets/widgets/material_select_option_nojs.html'
        )

    def get_context(self, name, value, attrs):
        context = super(MaterialSelectMultiple, self).get_context(name, value, attrs)
        attrs_class = (
            context[u'widget'][u'attrs'].get(u'class', u'')
            + u' mdc-multi-select mdc-list'
            ).strip()
        context[u'widget'][u'attrs'].update({
            u'class': attrs_class,
            })
...
class MaterialSliderInput(MaterialComponent, widgets.NumberInput):
    ...
    """
    template_name = u'material_widgets/widgets/material_slider.html'
    ...
    def __init__(self,
                 ...
                 persistent_help_text=True,
                 *args, **kwargs):
        super(MaterialSliderInput, self).__init__(*args, **kwargs)
        self.display_markers = display_markers
        self.is_discrete = is_discrete
        self.persistent_help_text = persistent_help_text

    def get_context(self, name, value, attrs):
        context = super(MaterialSliderInput, self).get_context(name, value, attrs)
        context[u'widget'].update({
            u'display_markers': self.display_markers,
            u'is_discrete': self.is_discrete,
            u'persistent_help_text': self.persistent_help_text,
            })
        return context

    class Media(object):  # pylint: disable=missing-docstring
        js = (u'material_widgets/js/material_slider.js',)


class MaterialSplitDateTimeWidget(MaterialMultiWidget):
    u"""Material SplitDateTimeWidget
    ...
    template_name = u'material_widgets/widgets/material_splitdatetime.html'

    def __init__(self,
                 attrs=None, date_format=None, time_format=None,
                 label=None,
                 date_label=u'Date', date_help_text=u'YYYY-MM-DD',
                 date_persistent_help_text=False,
                 time_label=u'Time', time_help_text=u'HH:MM:SS',
        ...
        super(MaterialSplitDateTimeWidget, self).__init__(multiwidgets, attrs, label, *args, **kwargs)
...
class MaterialSplitHiddenDateTimeWidget(MaterialSplitDateTimeWidget):
    u"""Material SplitHiddenDateTimeWidget
    ...
    """
    input_type = u'hidden'
    template_name = u'material_widgets/widgets/material_splithiddendatetime.html'

    def __init__(self, attrs=None, date_format=None, time_format=None):
        super(MaterialSplitHiddenDateTimeWidget, self).__init__(attrs, date_format, time_format, label=u'',
                         date_label=u'', date_help_text=u'',
                         date_persistent_help_text=False,
                         time_label=u'', time_help_text=u'',
                         time_persistent_help_text=False,
                        )
        for widget in self.widgets:
            widget.__class__ = MaterialHiddenInput
            widget.input_type = u'hidden'

class MaterialSwitchInput(MaterialComponent, widgets.CheckboxInput):
    u"""Material SwitchInput
    ...
    """
    template_name = u'material_widgets/widgets/material_switch.html'

    class Media(object):  # pylint: disable=missing-docstring
        css = {
            u'all': (
                u'material_widgets/css/material_switch.css',
                )
            }
...
class MaterialTextarea(MaterialTextField, widgets.Textarea):
    ...
    """
    template_name = u'material_widgets/widgets/material_textarea.html'


class MaterialTextInput(MaterialTextField, widgets.TextInput):
    u"""Material TextInput
    ...
    """
    template_name = u'material_widgets/widgets/material_text.html'


class MaterialTimeInput(MaterialTextField, widgets.TimeInput):
    u"""Material TimeInput
    ...
    """
    template_name = u'material_widgets/widgets/material_time.html'
...
class MaterialURLInput(MaterialTextField, widgets.URLInput):
    ...
    """
    template_name = u'material_widgets/widgets/material_url.html'
